...
#try gamma? #need to find better starting parameters,,,
hist(large$cpue_wt, breaks=20, prob=T)
# Overlay a gamma PDF curve for comparison
shape <- 6  # Adjust shape parameter as needed
rate <- 4 # Adjust rate parameter as needed
x <- seq(0, max(large$cpue_wt), length = 100)
