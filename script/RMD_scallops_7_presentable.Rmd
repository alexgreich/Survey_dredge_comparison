...
ggplot(large_m) + aes(x=haul, shape=gear_code, group= gear_code) +
...
ggplot(small_m) + aes(x=haul, shape=gear_code, group= gear_code) +
    geom_point(aes(y=cpue_wt), color="black", alpha=0.5)+
    geom_point(aes(y=fitted_cpue_wt), color="red", alpha=0.3)
...
########################################
Kappenman #THIS IS IT! THE CHANGE HAPPENS HERE!! Figure out why lm opperates differently before and after this code block
-I will try removing all things unnecessary
```{r}
#large
