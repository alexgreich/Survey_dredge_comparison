...
MSE sim Kapp (crap. Do I need to do and MSE sim for ANOVA as well or is kapp enough??... what did Tyler do?)
```{r}
#AR adjustments
...
#test
test_large <- f_kapp_mse_sim_AR1(data=large_m, n=10, method=4) #what should n be?
f_sim_plot(data=test_large, fpc=FPC_large_wt) 
```
