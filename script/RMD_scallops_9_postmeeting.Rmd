...
ggsave("figures/MSE_L.jpg", plot=comb1, height=5, width=10, units="in")
ggsave("figures/MSE_S.jpg", plot=comb2, height=5, width=10, units="in")
...
##graph
bb<-ggplot(specimen) + aes(x=shell_height, color=factor(gear_code), group=factor(gear_code)) + geom_density(aes(weight=sample_factor)) + #is sample factor based off of # cpue? needs to be. Yes, we are good there.
...
#formal density test, pre and post homer? (too hard with code running, do later)
