...
xx/yyy + plot_layout(guides="collect")
...
#ggsave("Split anova L.pdf", plot=x, height=10, width=20, units="in")
#ggsave("Split anova S.pdf", plot=y, height=10, width=20, units="in")
```
