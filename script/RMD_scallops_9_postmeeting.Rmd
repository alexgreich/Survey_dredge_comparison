...
ggsave("Split anova L.png", plot=x, height=10, width=20, units="in")
ggsave("Split anova S.png", plot=y, height=10, width=20, units="in")
```
...
#graph pre and post in order? nah.
