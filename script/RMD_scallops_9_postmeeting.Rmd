...
plot_RB_ANOVA_mse_large_pre<- f_sim_plot(data=RB_ANOVA_mse_large_pre, fpc=scallop_FPC_table[4,2])

length(s_post$haul)/2
RB_ANOVA_mse_small_post <- f_mse_sim_AR1(data=s_post, n=15, method=2) 
plot_RB_ANOVA_mse_large_post<- f_sim_plot(data=RB_ANOVA_mse_large_post, fpc=scallop_FPC_table[5,2])
