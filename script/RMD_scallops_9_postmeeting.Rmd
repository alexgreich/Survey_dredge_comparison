...
Category <- c("large(pre)" , "large(post)", "large(combined)", "small(pre)", "small(post)", "small(combined)")
...
scallop_FPC_table$repair <- factor(x=c("pre", "post", "combined", "pre", "post", "combined"))
...
Mean and SD for both kodiak and homer scallops??
```{r}
