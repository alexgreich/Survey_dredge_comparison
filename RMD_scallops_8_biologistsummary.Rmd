...
ggplot(restructured_data_l)+
    geom_smooth(aes(x=Homer_cpue_wt, y=Kodiak_cpue_wt), color="blue", method="lm") +
    geom_smooth(aes(x=Homer_FPC_applied, y=Kodiak_cpue_wt), color="red", method="lm")+
    geom_point(aes(x=Homer_cpue_wt, y=Kodiak_cpue_wt), color="blue")+
    geom_point(aes(x=Homer_FPC_applied, y=Kodiak_cpue_wt), color="red")
